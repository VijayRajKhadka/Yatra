...
<form action="{{ route('searchPlace') }}" method="GET" class="mb-3" style="float: right; width: 500px;">
    <div class="input-group">
        <input type="text" name="query" class="form-control" placeholder="Search places...">
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $place->updated_at->format('M d Y') }}</td>

            <td>
                <a href="{{ route('placeDetails', $place->place_id) }}" class="btn btn-outline-primary">
